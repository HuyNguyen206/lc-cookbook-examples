...
<body class="font-sans antialiased text-gray-900">
    <div class="min-h-screen bg-gray-100">
        ...
        <a href="{{route('announcement.show')}}" class="container p-4 flex items-center justify-center text-center bg-purple-800" style="background-color: {{$announcement->bannerColor}}">
            <div>
